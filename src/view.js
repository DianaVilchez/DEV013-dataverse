export const renderItems = (data) => {
  ...
  data.forEach((painting) => {
    ...
    <dt><img itemprop="image" itemtype="image" src="${painting.imageUrl}" alt="${painting.name}"></dd>
          <dt class="contenedor1" itemtype=""></dt><dd itemprop="name">${painting.name}</dd>
          <dt class="contenedor1" itemtype=""></dt><dd itemprop="artistName">${painting.facts.artistName}</dd>
          <dt class="contenedor1" itemtype=""></dt><dd itemprop="artMovement">${painting.facts.artMovement}</dd>
          <dt class="contenedor1" itemtype=""></dt><dd itemprop="creationYear">${painting.facts.creationYear}</dd>
          <dt class="contenedor1" itemtype=""></dt><dd itemprop="shortDescription">${painting.shortDescription}</dd>
        </dl>`;
